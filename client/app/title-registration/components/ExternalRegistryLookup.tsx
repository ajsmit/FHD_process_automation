  ...
  return (
    <>
      <label className='space-y-1 text-sm md:col-span-3 lg:col-span-6'>
        <span className={FORM_LABEL_CLASS}>Search external registry (surname/email/ID/passport)</span>
        <input
      ...
      <label className='space-y-1 text-sm md:col-span-3 lg:col-span-6'>
        <span className={FORM_LABEL_CLASS}>Lookup previously used external academics</span>
        <select className={FORM_CONTROL_CLASS} value={lookupValue} onChange={(event) => onLookupChange(event.target.value)}>
